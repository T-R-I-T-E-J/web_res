...
export default function CategoriesPage() {
  ...
  // Debounced values for potential validation or duplicate checking
  const debouncedName = useDebounce(newCat.name, 500)
  const debouncedSlug = useDebounce(newCat.slug, 500)
